...
| Template | Articles |
|----------|----------|
| `{{tmpl}}` | Nuclear weapon, Chernobyl exclusion zone
| `{{tmpl}}` | El Niño–Southern Oscillation, Deepwater Horizon oil spill
| `{{tmpl}}` | Earth Day, Nuclear weapon
| `{{tmpl}}` | Petroleum, Carbon dioxide, Breeder reactor, Extinction, Prisoner's dilemma
